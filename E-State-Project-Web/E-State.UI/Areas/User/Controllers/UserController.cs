...
namespace E_State.UI.Areas.User.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IActionResult Profile()
        {
            ...
            RegisterModel userViewModel = new RegisterModel();
        ...
        {
            return View(new E_State.UI.Areas.User.Models.LoginModel());
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task <IActionResult> Login(E_State.UI.Areas.User.Models.LoginModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
